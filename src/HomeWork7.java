...
public class HomeWork7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Среднее арифметическое: " + GrassHopper.findAverage(nums));
        System.out.println("Сумма разности элементов массива: " + SumOfDifferences.sumOfDifferences(nums));
    }
